...
export const metadata: Metadata = {
  ...
  description: "Encare um desafio com 12 questões oficiais das quatro áreas do ENEM e identifique assuntos para revisar na reta final.",
