...
export function PublicFooter() {
  return <footer className="enem-footer public-footer">
    ...
    <div><a href="mailto:contato@notafacil.com.br">contato@notafacil.com.br</a><p><a href="https://www.3cinova.com.br" target="_blank" rel="noopener noreferrer">Site institucional: www.3cinova.com.br</a></p><Link href="/entrar">Acesso do aluno</Link></div>
